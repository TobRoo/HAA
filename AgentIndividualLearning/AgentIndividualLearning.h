...
protected:
	...
	// Policy parameters
	std::string policy_;						// The policy being used
	float softmax_temp_min_;					// Coefficient for softmax policy temp
	float softmax_temp_max_;					// Coefficient for softmax policy temp
	float softmax_temp_transition_;				// Coefficient for softmax policy temp
	float softmax_temp_slope_;					// Coefficient for softmax policy temp
	float e_greedy_epsilon_;					// Probability of choosing random action with e-greedy policy
