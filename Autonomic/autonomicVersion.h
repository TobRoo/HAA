...
enum MSGS {
	...
	OAC_DDB_UPDATEQLEARNINGDATA, // Update learning data [UUID sender, char instance, bool usefulActions, float reward, int key, float qVal, unsigned int expVal]	
...
//	MSG__DDB_RESAMPLEPF_UNLOCK, // unlock the particle filter and distribute results [UUID pf, UUID key, char result, <_timeb tb, int particleNum, int stateSize, ... parents, ... state>]
	...
	MSG_DDB_UPDATE_QLEARNINGDATA, // upload qval & expval update [UUID ownerId, char agentType.instance, bool usefulAction, float reward, int key, float qval, int expVal] 
...
// -1=char, -2=uint, -3=byte+uint
	...
	sizeof(UUID) + sizeof(char) + sizeof(bool) + sizeof(float) + sizeof(int) + sizeof(float) + sizeof(unsigned int), //OAC_DDB_UPDATEQLEARNINGDATA  [UUID sender, char instance, bool usefulAction, float reward, int key, float qVal, unsigned int expVal]	
...
//	-2,					// MSG__DDB_RESAMPLEPF_UNLOCK
	...
	sizeof(UUID) + sizeof(char) + sizeof(bool) + sizeof(float) + sizeof(int) + sizeof(float) + sizeof(unsigned int), //MSG_DDB_UPDATE_QLEARNINGDATA [UUID ownerId, char agentType.instance, bool usefulAction, float reward, int key, float qval, int expVal] 
